...
+ (nullable NSString *)passwordForService:(NSString *)serviceName accessGroup:(NSString *)accessGroup account:(NSString *)account {
	return [self passwordForService:serviceName accessGroup:accessGroup account:account error:nil];
}
//#endif

+ (nullable NSString *)passwordForService:(NSString *)serviceName account:(NSString *)account {
	return [self passwordForService:serviceName accessGroup:nil account:account error:nil];
}

+ (nullable NSString *)passwordForService:(NSString *)serviceName accessGroup:(NSString *)accessGroup account:(NSString *)account error:(NSError *__autoreleasing *)error {
...
+ (BOOL)deletePasswordForService:(NSString *)serviceName accessGroup:(NSString *)accessGroup account:(NSString *)account {
	return [self deletePasswordForService:serviceName accessGroup:accessGroup account:account error:nil];
}
//#endif

+ (BOOL)deletePasswordForService:(NSString *)serviceName account:(NSString *)account {
	return [self deletePasswordForService:serviceName accessGroup:nil account:account error:nil];
}

+ (BOOL)deletePasswordForService:(NSString *)serviceName accessGroup:(NSString *)accessGroup account:(NSString *)account error:(NSError *__autoreleasing *)error {
	SAMKeychainQuery *query = [[SAMKeychainQuery alloc] init];
	query.service = serviceName;
	query.account = account;
//#ifdef SAMKEYCHAIN_ACCESS_GROUP_AVAILABLE
...
+ (BOOL)setPassword:(NSString *)password forService:(NSString *)serviceName accessGroup:(NSString *)accessGroup account:(NSString *)account {
	return [self setPassword:password forService:serviceName accessGroup:accessGroup account:account error:nil];
}
//#endif

+ (BOOL)setPassword:(NSString *)password forService:(NSString *)serviceName account:(NSString *)account {
	return [self setPassword:password forService:serviceName accessGroup:nil account:account error:nil];
}

+ (BOOL)setPassword:(NSString *)password forService:(NSString *)serviceName accessGroup:(NSString *)accessGroup account:(NSString *)account error:(NSError *__autoreleasing *)error {
	SAMKeychainQuery *query = [[SAMKeychainQuery alloc] init];
	query.service = serviceName;
	query.account = account;
